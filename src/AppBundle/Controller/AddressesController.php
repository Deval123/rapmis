...
class AddressesController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $addresses = $em->getRepository('AppBundle:Addresses')->findAll();
    ...
    public function uploadAdressesAction(Request $request){
        ...
        $nom_exel='addresses';
        $em = $this->getDoctrine()->getManager();
        $media1 = $em->getRepository('AppBundle:Media')->findOneBy(array('name' => 'addresses'));
...
//end read
    ...
    public function newAction(Request $request)
    {
        ...
        $form = $this->createForm('AppBundle\Form\AddressesType', $address);
        $form->handleRequest($request);
    ...
    {
        $deleteForm = $this->createDeleteForm($address);
        $editForm = $this->createForm('AppBundle\Form\AddressesType', $address);
