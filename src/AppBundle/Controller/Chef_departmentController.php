 ...
 *
 * @Route("chef_department")
 */
class Chef_departmentController extends Controller
{
    /**
    ...
    public function indexAction()
    {
        ...
        $chef_departments = $em->getRepository('AppBundle:Chef_department')
            ->createQueryBuilder('c')
            ->where('c.teacher IN (:teacher)')
            ->setParameter('teacher', $teacher)
            //dump($qb);
            ->getQuery()->getResult();
        //$chef_departments = $em->getRepository('AppBundle:Chef_department')->findAll();
...
//end read
    ...
    public function newAction(Request $request)
    {
        ...
        $form = $this->createForm('AppBundle\Form\Chef_departmentType', $chef_department);
        $form->handleRequest($request);
    ...
    {
        $deleteForm = $this->createDeleteForm($chef_department);
        $editForm = $this->createForm('AppBundle\Form\Chef_departmentType', $chef_department);
