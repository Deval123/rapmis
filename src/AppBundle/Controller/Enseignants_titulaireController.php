...
use AppBundle\Form\Enseignants_titulaireType;
use Symfony\Bundle\FrameworkBundle\Controller\Controller;
use Sensio\Bundle\FrameworkExtraBundle\Configuration\Method;
use Sensio\Bundle\FrameworkExtraBundle\Configuration\Route;
use Symfony\Component\HttpFoundation\Request;
use Sensio\Bundle\FrameworkExtraBundle\Configuration\Security;
use AppBundle\Repository\Enseignants_titulaireRepository;
 ...
 */
class Enseignants_titulaireController extends Controller
{
    /**
    ...
    public function indexAction()
    {
        ...
        //$enseignants_titulaires = $em->getRepository('AppBundle:Enseignants_titulaire')->findAll();


        $teacher = $em->getRepository('AppBundle:Teacher')
            ->findBy(array('etablissements'=>$this->getUser()->getEtablissements()));

        $enseignants_titulaires = $em->getRepository('AppBundle:Enseignants_titulaire')
    ...
    public function newAction(Request $request)
    {
        ...
        //$form = $this->createForm('AppBundle\Form\Enseignants_titulaireType', $enseignants_titulaire);
    ...
    {
        $deleteForm = $this->createDeleteForm($enseignants_titulaire);
        $editForm = $this->createForm('AppBundle\Form\Enseignants_titulaireType', $enseignants_titulaire);
