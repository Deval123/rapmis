...
use AppBundle\Entity\Events_extracurricular;
 ...
 */
class Events_extracurricularController extends Controller
{
    /**
    ...
    public function indexAction()
    {
        ...
        $events_extracurriculars = $em->getRepository('AppBundle:Events_extracurricular')->findAll();
    ...
    public function newAction(Request $request)
    {
        ...
        $form = $this->createForm('AppBundle\Form\Events_extracurricularType', $events_extracurricular);
    ...
    {
        $deleteForm = $this->createDeleteForm($events_extracurricular);
        $editForm = $this->createForm('AppBundle\Form\Events_extracurricularType', $events_extracurricular);
