...
use AppBundle\Entity\Fiche_parents;
 ...
 * @Route("fiche_parents")
 */
class Fiche_parentsController extends Controller
{
    /**
    ...
    public function indexAction()
    {
        ...
        $fiche_parents = $em->getRepository('AppBundle:Fiche_parents')->findAll();
    ...
    public function newAction(Request $request)
    {
        ...
        $form = $this->createForm('AppBundle\Form\Fiche_parentsType', $fiche_parent);
    ...
    {
        $deleteForm = $this->createDeleteForm($fiche_parent);
        $editForm = $this->createForm('AppBundle\Form\Fiche_parentsType', $fiche_parent);
