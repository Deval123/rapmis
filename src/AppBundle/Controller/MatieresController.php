...
class MatieresController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $matieres = $em->getRepository('AppBundle:Matieres')->findAll();
    ...
    public function uploadMatieresAction(Request $request)
    {
        ...
        $nom_exel='matieres';
        $em = $this->getDoctrine()->getManager();
        $media1 = $em->getRepository('AppBundle:Media')->findOneBy(array('name' => 'matieres'));
...
//end read
    ...
    {
        $matiere = new Matieres();
        $form = $this->createForm('AppBundle\Form\MatieresType', $matiere);
        $form->handleRequest($request);
    ...
    {
        $deleteForm = $this->createDeleteForm($matiere);
        $editForm = $this->createForm('AppBundle\Form\MatieresType', $matiere);
