...
class ModulesController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $modules = $em->getRepository('AppBundle:Modules')->findAll();
    ...
    {
        $module = new Modules();
        $form = $this->createForm('AppBundle\Form\ModulesType', $module);
    ...
    {
        $deleteForm = $this->createDeleteForm($module);
        $editForm = $this->createForm('AppBundle\Form\ModulesType', $module);
