...
class NiveauController extends Controller
{
    ...
    public function uploadNiveauAction(Request $request)
    {
        ...
        $nom_exel='niveau';
        $em = $this->getDoctrine()->getManager();
        $media1 = $em->getRepository('AppBundle:Media')->findOneBy(array('name' => 'niveau'));
...
//end read
            ...
            foreach ($objWorksheet->getRowIterator() as $row) {
                ...
                $mat = $em1->getRepository('AppBundle:Matieres')->findOneBy(array(
    ...
    {
        $niveau = new Niveau();
        $form = $this->createForm('AppBundle\Form\NiveauType', $niveau);
        $form->handleRequest($request);
    ...
    {
        $deleteForm = $this->createDeleteForm($niveau);
        $editForm = $this->createForm('AppBundle\Form\NiveauType', $niveau);
