 ...
 * @Route("sectioneduc")
 */
class SectionEducController extends Controller
{
    /**
    ...
    public function indexAction()
    {
        ...
        $sectionEducs = $em->getRepository('AppBundle:SectionEduc')->findAll();
    ...
    public function uploadSyseducAction(Request $request)
    {
        ...
        $em = $this->getDoctrine()->getManager();
        $media1 = $em->getRepository('AppBundle:Media')->findOneBy(array('name' => 'section éducatif'));
...
//end read
    ...
    {
        $sectionEduc = new Sectioneduc();
        $form = $this->createForm('AppBundle\Form\SectionEducType', $sectionEduc);
        $form->handleRequest($request);
    ...
    {
        $deleteForm = $this->createDeleteForm($sectionEduc);
        $editForm = $this->createForm('AppBundle\Form\SectionEducType', $sectionEduc);
