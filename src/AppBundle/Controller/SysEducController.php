 ...
 * @Route("syseduc")
 */
class SysEducController extends Controller
{
    /**
    ...
    public function indexAction()
    {
        ...
        $sysEducs = $em->getRepository('AppBundle:SysEduc')->findAll();
    ...
    public function uploadSyseducAction(Request $request)
    {
        ...
        $nom_exel='SysEduc';
        $em = $this->getDoctrine()->getManager();
        $media1 = $em->getRepository('AppBundle:Media')->findOneBy(array('name' => 'système éducatif'));
...
//end read
    ...
    {
        $sysEduc = new Syseduc();
        $form = $this->createForm('AppBundle\Form\SysEducType', $sysEduc);
        $form->handleRequest($request);
    ...
    {
        $deleteForm = $this->createDeleteForm($sysEduc);
        $editForm = $this->createForm('AppBundle\Form\SysEducType', $sysEduc);
