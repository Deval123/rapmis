 ...
 */
class Type_etablissementsController extends Controller
{
    /**
    ...
    public function indexAction()
    {
        ...
        $type_etablissements = $em->getRepository('AppBundle:Type_etablissements')->findAll();
    ...
    public function uploadType_etablissementsAction(Request $request)
    {
        ...
        $em = $this->getDoctrine()->getManager();
        $media1 = $em->getRepository('AppBundle:Media')->findOneBy(array('name' => 'type d\'établissements'));
...
//end read
    ...
    {
        $type_etablissement = new Type_etablissements();
        $form = $this->createForm('AppBundle\Form\Type_etablissementsType', $type_etablissement);
        $form->handleRequest($request);
    ...
    {
        $deleteForm = $this->createDeleteForm($type_etablissement);
        $editForm = $this->createForm('AppBundle\Form\Type_etablissementsType', $type_etablissement);
