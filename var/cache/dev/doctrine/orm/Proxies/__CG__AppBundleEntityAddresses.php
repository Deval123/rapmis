 ...
 */
class Addresses extends \AppBundle\Entity\Addresses implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\Addresses' . "\0" . 'id', '' . "\0" . 'AppBundle\\Entity\\Addresses' . "\0" . 'tel', '' . "\0" . 'AppBundle\\Entity\\Addresses' . "\0" . 'email', '' . "\0" . 'AppBundle\\Entity\\Addresses' . "\0" . 'bP', '' . "\0" . 'AppBundle\\Entity\\Addresses' . "\0" . 'fax', '' . "\0" . 'AppBundle\\Entity\\Addresses' . "\0" . 'longitude', '' . "\0" . 'AppBundle\\Entity\\Addresses' . "\0" . 'latitude'];
        }
