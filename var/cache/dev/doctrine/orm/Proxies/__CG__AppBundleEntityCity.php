...
class City extends \AppBundle\Entity\City implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\City' . "\0" . 'id', '' . "\0" . 'AppBundle\\Entity\\City' . "\0" . 'name', '' . "\0" . 'AppBundle\\Entity\\City' . "\0" . 'longitude', '' . "\0" . 'AppBundle\\Entity\\City' . "\0" . 'latitude', '' . "\0" . 'AppBundle\\Entity\\City' . "\0" . 'departments'];
        }
    ...
    public function setDepartments(\AppBundle\Entity\Department $departments = NULL)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setDepartments', [$departments]);
