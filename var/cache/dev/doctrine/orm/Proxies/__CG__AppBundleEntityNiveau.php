...
class Niveau extends \AppBundle\Entity\Niveau implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\Niveau' . "\0" . 'id', '' . "\0" . 'AppBundle\\Entity\\Niveau' . "\0" . 'name', '' . "\0" . 'AppBundle\\Entity\\Niveau' . "\0" . 'description', '' . "\0" . 'AppBundle\\Entity\\Niveau' . "\0" . 'matieres'];
        }
    ...
    public function setMatieres($matieres)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setMatieres', [$matieres]);

        return parent::setMatieres($matieres);
    }
